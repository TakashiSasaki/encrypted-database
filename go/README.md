...
The Go implementation is not a full, production-ready library. Currently, a minimal JCS canonicalizer, an Argon2id KDF test, and AES-256-GCM AEAD primitive vector validation are implemented solely to satisfy the basic AAD, KDF, and AEAD test vectors. Full storage database features, including SQLite validation, unlock, decrypt, and writer functionality, are future tasks.
