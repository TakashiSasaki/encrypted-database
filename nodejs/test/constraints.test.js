...
describe('SQL Constraints V1', () => {
    ...
    it('should enforce CHECK constraints on database', async () => {
        ...
        const objectUuid = "12345678-1234-1234-1234-123456789012";

        // 1. encrypted_object_tbl.nonce 12 bytes
        expect(() => {
            db.prepare("INSERT INTO encrypted_object_tbl (object_uuid, schema_uuid, envelope_v, envelope_type, content_type, alg, kid, nonce, ciphertext, aad_policy) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)").run(
        ...
        const wrapId = "00000000-0000-0000-0000-000000000000";
        expect(() => {
