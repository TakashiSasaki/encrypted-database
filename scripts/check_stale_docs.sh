...
check_phrase "Java read/write support complete" "False claim: Java read/write support is not complete"
...
check_phrase "Java encryption implemented" "False claim: Java encryption is not implemented"
check_phrase "Java SQLite implementation complete" "False claim: Java SQLite implementation is not complete"
check_phrase "Java Argon2id implementation complete" "False claim: Java Argon2id implementation is not complete"
