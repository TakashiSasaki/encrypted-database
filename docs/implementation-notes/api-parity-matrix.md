...
| JCS canonicalization | implemented-public | implemented-public | implemented-test-harness | implemented-scaffold | implemented-scaffold | implemented-scaffold | partial | partial | C/C++ have an internal generated-AST JCS basic-vector serializer scaffold only; an initial parser-free internal model scaffold and generated-vector bridge exist, but generic JCS is not yet implemented. |
