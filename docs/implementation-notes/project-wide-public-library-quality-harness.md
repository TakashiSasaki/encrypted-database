...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| Python | `python/` | baseline-public | implemented-public | implemented-public | not applicable | passed | passed | implemented-public | path-filtered | partial | baseline-public | Baseline implementation. API exists and passes execution matrix. |
| Node.js | `nodejs/` | baseline-public | implemented-public | implemented-public | not applicable | passed | passed | implemented-public | path-filtered | partial | baseline-public | Baseline implementation. API exists and passes execution matrix. |
...
|---|---|---|---|
| Python -> Python | passed | Successfully executed cross-language tests | Matrix runner |
| Node.js -> Node.js | passed | Successfully executed cross-language tests | Matrix runner |
| Python -> Node.js | passed | Successfully executed cross-language tests | Matrix runner |
| Node.js -> Python | passed | Successfully executed cross-language tests | Matrix runner |
...
- **Python / Node.js:** Baseline implementations defining the standard.
