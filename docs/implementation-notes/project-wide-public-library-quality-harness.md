...
- **baseline-candidate**: A candidate for baseline-public. Passes cross-language matrix via test wrappers, but public-quality certification is pending.
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| Python | `python/` | baseline-candidate | implemented-public* | implemented-public* | not applicable | test-wrapper-passed | test-wrapper-passed | implemented-public* | path-filtered | partial | preview-library | Baseline candidate. API exists and passes execution matrix via test wrappers; public-quality certification pending. |
| Node.js | `nodejs/` | baseline-candidate | implemented-public* | implemented-public* | not applicable | test-wrapper-passed | test-wrapper-passed | implemented-public* | path-filtered | partial | preview-library | Baseline candidate. API exists and passes execution matrix via test wrappers; public-quality certification pending. |
...
|---|---|---|---|
| Python -> Python | test-wrapper-passed | Successfully executed test-only compatibility wrapper checks | Matrix runner |
| Node.js -> Node.js | test-wrapper-passed | Successfully executed test-only compatibility wrapper checks | Matrix runner |
| Python -> Node.js | test-wrapper-passed | Successfully executed test-only compatibility wrapper checks | Matrix runner |
| Node.js -> Python | test-wrapper-passed | Successfully executed test-only compatibility wrapper checks | Matrix runner |
