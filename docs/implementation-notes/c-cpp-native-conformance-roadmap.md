...
- **Explicit classification of JCS vectors**: Clearly document the classification of active vectors, non-active seed vectors (like `utf16-key-ordering.json`), and planning-only vectors, strictly controlling which are wired into the C/C++ scaffolds.
