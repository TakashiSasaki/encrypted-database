...
|---|---|---|---|
| Public read API surface | implemented-public* | implemented-public* | API surface exists; semantic review pending |
| Public write API surface | implemented-public* | implemented-public* | API surface exists; semantic review pending |
| Storage Format V1 semantic stability | pending | pending | Verify no hidden assumptions before locking public API |
| Shared conformance vectors | partial | partial | Full RFC 8785 vector coverage required across libraries |
...
| API/error semantics | pending | pending | Ensure cross-language error code mapping consistency |
