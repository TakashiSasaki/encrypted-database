...
This directory contains records of the major architectural decisions made for the Encrypted Database project.

- [ADR-0001: Use UUIDv4 Canonical String for Key Identifiers (`kid`)](./ADR-0001-use-uuidv4-canonical-kid.md)
