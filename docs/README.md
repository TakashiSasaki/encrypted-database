...
*Note: Go and Rust directories are currently portability-validation scaffolds. They include SQLite V1 read-only metadata validators/readers and writer scaffolds. They are intended to consume shared conformance vectors, validate read/write scaffold interoperability, and uncover portability issues. They are not yet full production storage libraries. Storage Format V1 is Stable. Go/Rust portability work validates the stable format. Remaining issues should be tracked as implementation gaps, non-breaking clarifications, implementation bugs, test gaps, test vector corrections, driver/library limitations, or future V2 items. The library as a whole is not yet declared production-ready.*
...
- [`implementation-notes/c-cpp-generic-jcs-implementation-decision.md`](./implementation-notes/c-cpp-generic-jcs-implementation-decision.md): Generic JCS implementation decision for C/C++.
- [`implementation-notes/c-cpp-jcs-parser-dependency-decision.md`](./implementation-notes/c-cpp-jcs-parser-dependency-decision.md): JCS parser and dependency decision for C/C++.
- [`implementation-notes/c-cpp-jcs-internal-value-model-decision.md`](./implementation-notes/c-cpp-jcs-internal-value-model-decision.md): JCS internal value model boundary decision for C/C++.
