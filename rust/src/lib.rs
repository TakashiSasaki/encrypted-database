//! Vault Cryptographic Database Scaffold
//!
//! This crate is currently a portability validation scaffold.
//! It provides minimal tools for parsing conformance test vectors.
