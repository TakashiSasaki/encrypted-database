...
The Rust implementation is not a full, production-ready library. Currently, a minimal JCS canonicalizer is implemented solely to satisfy the basic AAD test vectors. Full storage database features, including SQLite validation, unlock, decrypt, and writer functionality, are future tasks.
